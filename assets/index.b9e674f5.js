...
`,Q=a.div`
    ...
    width: 70%;
`,X={hover:{staggerChildren:.5},initial:{staggerChildren:.5}},Z={initial:{left:"-100%"},hover:{left:0}};var S=e=>{const[r,n]=s.exports.useState("hover"),[c,o]=s.exports.useState("black");return p(W,{onTap:()=>{n("initial"),e.onClick()},onHoverEnd:()=>{e.disabled||n("hover")},color:e.color,type:"button",variants:X,whileHover:r,initial:"initial",width:e.width||"50%",children:[t(Y,{variants:Z,transition:{duration:.2,type:"tween"},color:e.color,error:e.error}),t(q,{textColour:c,children:e.text})]})},C=s.exports.createContext(),_=e=>{const{username:r,password:n,setRegisterColour:c,setError:o,setMessage:i}=e,l={username:r,password:n,pokemon:"pikachu"};b.post("https://yayapokefav.herokuapp.com/api/users/",l).then(d=>{c("rgb(0, 208, 0)"),o(!1),i("Account has been created! You may now login.")}).catch(d=>{c("rgb(255,0,0)"),o(!0),i(d.response.data.detail)})},z=e=>{const{username:r,password:n,setUser:c,setLoginColour:o,setError:i,setMessage:l,navigate:d}=e;b.get(`https://yayapokefav.herokuapp.com/api/users/${r}`).then(h=>{h.data.password==n?(c(h.data),localStorage.setItem("user",r),d("/profile")):(o("rgb(255,0,0)"),i(!0),l("Username and/or password is incorrect."))}).catch(h=>{o("rgb(255,0,0)"),i(!0),l("Username and/or password is incorrect.")})};const ee={enter:{opacity:1,transition:{type:"tween",duration:.15,delay:.2}},exit:{opacity:0,transition:{type:"tween",duration:.15}}};var te=()=>{const[e,r]=s.exports.useState(""),[n,c]=s.exports.useState(""),[o,i]=s.exports.useState("rgb(52, 53, 57)"),[l,d]=s.exports.useState("rgb(52, 53, 57)"),[h,f]=s.exports.useState(!0),[P,k]=s.exports.useState(""),[E,x]=s.exports.useContext(C),v=w(),m=u=>{u.key=="Enter"&&z({username:e,password:n,setUser:x,setLoginColour:d,setError:f,setMessage:k,navigate:v})};return p(I,{children:[localStorage.getItem("user")&&t(B,{to:"/profile",replace:!0}),p(G,{variants:ee,initial:"exit",animate:"enter",exit:"exit",children:[t(T,{placeholder:"Username",onKeyPress:m,onChange:u=>r(u.target.value)}),t(T,{placeholder:"Password",onKeyPress:m,type:"password",onChange:u=>c(u.target.value)}),p(J,{children:[t(S,{text:"LOGIN",onClick:()=>z({username:e,password:n,setUser:x,setLoginColour:d,setError:f,setMessage:k,navigate:v}),color:l,setButtonColour:d}),t(S,{text:"REGISTER",onClick:()=>_({username:e,password:n,setRegisterColour:i,setError:f,setMessage:k}),color:o,setButtonColour:i})]}),t(Q,{error:h,children:P})]})]})},oe=a(g.div)`
    background: white;
    max-width: 350px;
    width: 90%;
    height: 400px;
